...
class GroupMutualProximity(mir3.module.Module):
    def get_help(self):
        return """Recommendations based on Group Mutual Proximity"""
    ...
    def run(self, args):
        ...
        a.data, q, w = pca.PCA(a.data, scale=1)
        ...
        D = dist.mutual_proximity(dist.distance_matrix(
            numpy.vstack( (testing_data, training_data))))

        #print D

        score = dist.group_subset_distance(D, (0, testing_data.shape[0]),\
