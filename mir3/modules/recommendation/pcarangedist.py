...
class PCARangeDistance(mir3.module.Module):
    def get_help(self):
        return """Recommendations based on Range Distance with PCA pre-processing"""
    ...
    def run(self, args):
        ...
        # PCA algorithm
        testing_data, training_data = pca.subset_PCA \
                          (testing_data, training_data)

        # rangedist algorithm
        score = numpy.array(knn.range_distance
                          (testing_data, training_data))
