...
class OrthogonalProjectionNorm(mir3.module.Module):
    def get_help(self):
        return """Recommendations based on Orthogonal Projection Norm"""
    ...
    def run(self, args):
        ...
        # OPN algorithm
        opn, o, t = numpy.array(pca.orthogonal_projection
